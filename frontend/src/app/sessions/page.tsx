...
async function getSessions(): Promise<Session[]> {
  try {
    const response = await fetch(`${getBackendBaseUrl()}/api/v1/sessions/dummy`, {
      headers: {
    ...
    <div className="min-h-screen bg-background text-foreground p-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">View and manage your recorded HTTP sessions</p>
        </div>
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h2 className="text-xl font-semibold text-foreground mb-1">{session.name}</h2>
